...
int main ()
{
  ...
  // % 50 = add i64 % 45 , 1
  llvm::Value* var50 =
    builder.CreateAdd (var45 , getConst (64 , 1));
  ...
  // % 55 = add i64 % 45 , 2 
  llvm::Value* var55 =
    builder.CreateAdd (var45 , getConst (64 , 2));
...
llvm::ArrayRef<llvm::Value*>{getConst (64 , 0) , var55 , getConst (64 , 0)});
  ...
  var64 , llvm::ConstantDataVector::get (
...
var65 , llvm::ConstantDataVector::get (
    context , llvm::ArrayRef<uint32_t>{300 , 300 , 300 , 300 ,
    300 , 300 , 300 , 300}));

  // % 67 = trunc <8 x i32> % 66 to <8 x i16>
  llvm::Value* var67 = builder.CreateTrunc (var66 , llvm::VectorType::get (builder.getInt16Ty () , 8));
...
llvm::ArrayRef<llvm::Value*>{getConst (64 , 0) , getConst (64 , 0) , var13});
  ...
  llvm::Value* var69 =
    builder.CreateBitCast (var68 , llvm::PointerType::get (llvm::VectorType::get (builder.getInt16Ty () , 8) , 0));
 ...
 llvm::ConstantDataVector::get (
    context , llvm::ArrayRef<uint16_t>{12799 , 12799 , 12799 , 12799 ,
    12799 , 12799 , 12799 , 12799}) , var67);
...
llvm::ArrayRef<llvm::Value*>{getConst (64 , 0) , getConst (64 , 299) , var13});
  ...
  llvm::Value* var72 =
    builder.CreateBitCast (var71 , llvm::PointerType::get (llvm::VectorType::get (builder.getInt16Ty () , 8) , 0));
